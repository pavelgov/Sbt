...
public class Main {
    ...
    public static void main(String[] args) throws ClassNotFoundException, IllegalAccessException, InstantiationException, IOException {
      ...
      */
        ...
        EncryptedClassloader encLoader = new EncryptedClassloader("key", new File("C:\\Sbt\\Sbt\\lesson7\\EncryptedClassloader\\src\\sbt\\rnd\\javaschool\\plugins"), Main.class.getClassLoader());
